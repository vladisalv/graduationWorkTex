set terminal png
set output '../image/gpuC1a.png'		# установка вывода

set title  "BLOCK-программа"
...
plot 'data/gpuC1a.data' u 1 lt rgb 'brown' title "1 mpi x 1 GPU",\
     'data/gpuC1a.data' u 2 lt rgb 'green' title "2 mpi x 1 GPU",\
     'data/gpuC1a.data' u 3 lt rgb 'red'   title "4 mpi x 1 GPU"
